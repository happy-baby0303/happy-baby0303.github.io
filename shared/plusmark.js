...
(function () {
    ...
    var PLUS_TITLES = [
        ...
        "오늘 어디 가세요",
        "이 유모차에 얹히나",
        /* ⚠️ 위 제목은 '아직 카시트를 안 고른 사람' 에게만 뜬다.
              고르고 나면 제목이 판정으로 바뀌는데(얹힙니다 / 안 얹힙니다 …) 그 제목들이 빠져 있어서,
              정작 돈 내고 보는 화면에 PLUS 배지가 사라졌다. 트렁크 카드는 이미 들어가 있다. */
        "얹힙니다",
        "저희도 모릅니다",
        "카시트를 얹을 수 있나요",
        "우리 차에 들어가나",
        ...
        /* 새로 만들면 여기에 한 줄씩 늘리세요.
           \u26a0\ufe0f 반드시 위 ]; 안쪽에 넣어야 합니다. 밖에 두면 파일 전체가 안 돕니다.
           \u26a0\ufe0f 안전 문장("~ 하지 마세요")은 절대 넣지 마세요. 무료여야 합니다.
