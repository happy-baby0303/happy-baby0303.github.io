/* ============================================================
   ...
   ─────────────────────────────────────────────
   ⚠️ 아래 목록과 밑의 PLAN 표가 서로 달랐다.
      "기준은 여기 하나" 라고 적어놓고 머리말과 표가 어긋나 있었으니
      헷갈리지 말라고 만든 파일이 헷갈리게 만들고 있었다.
      돌아가는 건 표다. 표에 맞춰 목록을 고쳤다.
   ...
   프리미엄
     ...
     · 가족 5명까지 (조부모 초대)
     · 배냇함 포토북 내보내기
     · 아기 프로필 3명까지                 ← '무제한' 아니다. script.js 가 3에서 막는다
