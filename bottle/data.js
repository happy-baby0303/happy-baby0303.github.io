// ==========================================
// 🍼 육아메이트 젖병 통합 데이터베이스 V2.1 (bottle/data.js)
// (총 40종: 열탕/UV 소독 팩트체크 및 현실 육아 반영)
// ==========================================
...
const bottleData = [
    ...
    { 
        ...
        desc: "배앓이계의 1타 강사. 부품(통기시스템)이 많아 일명 '설거지 지옥'으로 불리지만, 배앓이 차단 효과는 의심할 여지가 없습니다.",
    ...
    { 
        ...
        desc: "인스타 감성의 예쁜 디자인과 더블하트 모유실감 젖꼭지 완벽 호환으로 인기입니다.",
    ...
    { 
        ...
        desc: "몸통 전체가 말랑말랑한 100% 실리콘. 젖병 거부 아기들에게 최고의 선택지지만 무겁고 먼지가 잘 붙는 단점이 있습니다.",
    ...
    { 
        ...
        desc: "성능은 기존 모유실감과 완벽히 동일하나, 귀여운 곰돌이 푸 등 캐릭터가 새겨져 있어 엄마들의 소장 욕구를 자극합니다.",
    ...
    { 
        ...
        material: "pp", price: "low", antiColic: "super", compatible: "no", 
        sterilization: "열탕(O)",
        desc: "영국 1위 젖병. 엄마 가슴을 닮은 넓은 젖꼭지로 유두 혼동을 줄여주며, '온도 센서' 튜브가 있어 초보 엄빠에게 매우 유용합니다.",
    ...
    { 
        ...
        material: "glass", price: "mid", antiColic: "super", compatible: "no", 
        sterilization: "열탕(O) / 식세기(O) / UV(O)",
        desc: "와이드넥보다 입구가 좁아 분유 넣고 씻기는 헬(Hell)이지만, 입이 작은 신생아나 미숙아(이른둥이)가 무는 데는 최고입니다.",
