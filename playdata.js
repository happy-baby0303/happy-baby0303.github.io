...
const playDB = [
    ...
    // ================= [3~5개월] =================
    { minM: 3, maxM: 5, title: "비닐봉지 바스락바스락", desc: "깨끗한 비닐봉지를 아기 귀 옆에서 구겨서 바스락 소리를 들려주세요. ", effect: "👂 청각 자극 및 두뇌 발달" },
    ...
    /* 🆕 새로 추가된 3~5개월 놀이 */
    { minM: 3, maxM: 5, title: "헬륨 풍선 발차기", desc: "아기 발목에 가벼운 헬륨 풍선 끈을 느슨하게 묶어주고 발을 찰 때마다 풍선이 움직이게 해주세요.", effect: "🎈 대근육 발달 및 인과관계 파악" },
    { minM: 3, maxM: 5, title: "입술로 배에 푸~ 방귀 소리", desc: "기저귀를 갈 때 아기 배에 입술을 대고 '푸르르~' 방귀 소리를 내며 간지럼을 태워주세요.", effect: "😆 강력한 스킨십 및 웃음 유도" },
    { minM: 3, maxM: 5, title: "페트병 콩그락 콩그락", desc: "빈 페트병에 콩이나 쌀을 조금 넣고 흔들어 마라카스처럼 소리를 들려주세요.", effect: "🥁 청각 발달 및 호기심 자극" },
    ...
    { minM: 25, maxM: 36, title: "집 안 보물찾기", desc: "작은 젤리나 아이가 좋아하는 미니 장난감을 소파 뒤, 쿠션 밑에 숨기고 찾아오게 하세요.", effect: "🗺️ 추리력 및 공간 탐색 능력" },
    { minM: 25, maxM: 36, title: "휴지심/빨대 목걸이 만들기", desc: "휴지심을 여러 조각으로 자르거나 짧게 자른 빨대를 운동화 끈에 꿰어 목걸이를 만드세요.", effect: "📿 초집중력 및 눈-손 협응 심화" }
];
