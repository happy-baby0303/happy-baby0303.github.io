// [5분 놀이 DB] 기존 리스트 + 새로운 일상 밀착형 놀이 대거 추가
// ⚠️ 안전 점검: 발목에 풍선 끈 묶기 · 비닐봉지 · 고무풍선 · 숨긴 젤리 · 목걸이 · 휴지심을 통과하는 작은 공 을 뺐다.
//    영아 질식·끼임 사고의 흔한 원인이라, 놀이를 알려주는 앱이 권하면 안 된다.
const playDB = [
    // ================= [0~2개월] =================
    ...
    { minM: 0, maxM: 2, title: "손수건 엄마 냄새 킁킁", desc: "엄마 냄새가 밴 깨끗한 손수건을 아기 코 가까이 잠깐 흔들어 주고, 놀고 나면 치워주세요. 잠자리에는 두지 않아요.", effect: "👃 후각 자극 및 심리적 안정" },
    ...
    { minM: 0, maxM: 2, title: "배냇저고리 패션쇼", desc: "여러 옷을 입혀주며 '오늘 우리 하윤이 스타일은 이탈리아 감성~' 하고 패션 리뷰를 해주세요.", effect: "🗣️ 언어 자극 및 정서 교감" },
    { minM: 0, maxM: 2, title: "발가락 꼼지락 카운트", desc: "아기 발가락을 하나씩 만지며 '하나, 둘, 셋, 넷, 다섯!' 세어주세요.", effect: "👣 말초신경 및 숫자 감각" },
    /* 🆕 새로 추가된 0~2개월 놀이 */
    { minM: 0, maxM: 2, title: "아빠 손가락 꽉 쥐기", desc: "아기 손바닥에 아빠 검지손가락을 대주어 반사적으로 꽉 쥐게 해보세요.", effect: "✊ 파악 반사 및 소근육 기초" },
    { minM: 0, maxM: 2, title: "공기 펌프 바람 솔솔", desc: "입으로 바람을 약하게 후~ 불어 아기 정수리나 볼에 부드럽게 닿게 해주세요.", effect: "🌬️ 새로운 피부 촉각 자극" },
    { minM: 0, maxM: 2, title: "백색소음 리듬 타기", desc: "쉬~ 소리나 청소기 소리를 약하게 틀어두고 안아서 가볍게 바운스를 타주세요.", effect: "🎵 심리적 안정감 및 수면 유도" },
    { minM: 0, maxM: 2, title: "손전등 불빛 탐색", desc: "방을 어둡게 하고 벽에 손전등 불빛을 비춰 천천히 움직여보세요.", effect: "🔦 명암 구별 및 시각 추적" },
    
    // ================= [3~5개월] =================
    { minM: 3, maxM: 5, title: "종이 바스락바스락", desc: "포장지나 신문지를 아기 귀 옆에서 구겨 바스락 소리를 들려주세요. 비닐봉지는 얼굴을 덮으면 숨을 막을 수 있어 쓰지 않아요.", effect: "👂 청각 자극 및 두뇌 발달" },
    ...
    { minM: 3, maxM: 5, title: "첨벙첨벙 물장구", desc: "목욕 시간, 욕조에 장난감을 띄우고 물을 손으로 쳐서 물방울을 보여주세요. 한 손은 늘 아기를 잡고 있어요.", effect: "💧 물에 대한 적응력 및 소근육" },
    { minM: 3, maxM: 5, title: "스카프 잡기 낚시", desc: "하늘하늘한 스카프를 아기 손에 닿을 듯 말 듯 흔들어주세요. 잡으면 크게 리액션 해주세요.", effect: "🖐 소근육 및 자신감" },
    { minM: 3, maxM: 5, title: "물체 사라졌다 나타나기", desc: "아기 눈앞에서 장난감을 이불 속으로 숨겼다 다시 꺼내주세요. 템포를 조절해 보세요.", effect: "🧠 대상 영속성 심화" },
    /* 🆕 새로 추가된 3~5개월 놀이 */
    { minM: 3, maxM: 5, title: "발차기 딸랑이", desc: "누운 아기 발끝에 딸랑이나 부드러운 공을 대주고, 발로 찰 때마다 소리가 나게 해주세요. 끈으로 발목에 묶지는 않아요.", effect: "🎈 대근육 발달 및 인과관계 파악" },
    { minM: 3, maxM: 5, title: "입술로 배에 푸~ 방귀 소리", desc: "기저귀를 갈 때 아기 배에 입술을 대고 '푸르르~' 방귀 소리를 내며 간지럼을 태워주세요.", effect: "😆 강력한 스킨십 및 웃음 유도" },
    { minM: 3, maxM: 5, title: "페트병 콩그락 콩그락", desc: "빈 페트병에 콩이나 쌀을 조금 넣고 뚜껑을 테이프로 단단히 감아, 마라카스처럼 흔들어 소리를 들려주세요. 아기 혼자 갖고 놀게 두지는 않아요.", effect: "🥁 청각 발달 및 호기심 자극" },
    { minM: 3, maxM: 5, title: "거울 속 나랑 대화하기", desc: "큰 거울 앞으로 아기를 안고 가서 거울 속 아기 얼굴을 만지며 이름을 불러주세요.", effect: "🪞 자아 인식 및 시각 발달" },

    // ================= [6~8개월] =================
    { minM: 6, maxM: 8, title: "수건으로 장난감 숨기기", desc: "장난감 위에 얇은 손수건을 올렸다가 아기가 직접 들춰보게 하세요.", effect: "🧠 대상 영속성(기억력) 발달" },
    { minM: 6, maxM: 8, title: "물티슈 캡 쏙쏙 뽑기", desc: "다 쓴 물티슈 통 안에 손수건이나 자투리 천을 넣고 아기가 마음껏 뽑게 해주세요. 긴 끈은 목에 감길 수 있어 넣지 않아요.", effect: "🤏 소근육 조작 및 성취감" },
    ...
    { minM: 6, maxM: 8, title: "미역/국수 오감 촉감놀이", desc: "삶은 소면이나 불린 미역을 김장 매트에 깔고 마음껏 만지고 던지게 해주세요.", effect: "🍝 두뇌 자극이 큽니다 (치우기 주의)" },
    { minM: 6, maxM: 8, title: "리듬 맞춰 몸 흔들기", desc: "신나는 동요를 틀어놓고 엄마아빠가 과장되게 춤추며 아기를 무릎에 앉혀 흔들어주세요.", effect: "🎵 리듬감 및 정서적 흥겨움" },
    { minM: 6, maxM: 8, title: "주방 서랍 보물찾기", desc: "안전한 주방 서랍(밀폐용기 등)을 열어주고 아기가 직접 꺼내게 하세요.", effect: "🧐 호기심 및 문제해결력" },
    { minM: 6, maxM: 8, title: "빨래 개기 도우미", desc: "빨래를 갤 때 아기 옆에 수건을 놔주세요. 아기가 구기거나 덮어쓰는 것도 놀이입니다.", effect: "👕 참여 의식 및 협동심" },
    /* 🆕 새로 추가된 6~8개월 놀이 */
    { minM: 6, maxM: 8, title: "얼음 지퍼백 만지기", desc: "이중 지퍼백에 각얼음을 넣고 차가운 촉감을 손바닥으로 느끼게 해주세요. (입에 넣지 않게 주의)", effect: "🧊 온도 인지 및 새로운 촉각" },
    { minM: 6, maxM: 8, title: "의자 터널 통과하기", desc: "식탁 의자를 일렬로 세워 터널을 만들고, 반대편에서 장난감으로 유혹해 기어오게 하세요.", effect: "🚇 전신 대근육 및 목표 달성" },
    { minM: 6, maxM: 8, title: "휴지 뽑기 대잔치", desc: "각티슈 대신, 다 쓴 빈 각티슈 통에 손수건을 여러 장 이어 넣어 마음껏 뽑게 해주세요.", effect: "🧻 소근육 발달 및 저지레 본능 충족" },
    { minM: 6, maxM: 8, title: "테이프 구출 작전", desc: "아기 손등이나 옷에 마스킹 테이프를 살짝 붙여두고 스스로 떼어보게 하세요.", effect: "🤏 정교한 손끝 조작 능력" },

    // ================= [9~12개월] =================
    { minM: 9, maxM: 12, title: "이불 속 구출 작전", desc: "아기가 보는 앞에서 최애 장난감을 이불 깊숙이 숨기고 찾아보게 하세요.", effect: "🕵️‍♂️ 문제 해결 능력 및 공간 지각" },
    { minM: 9, maxM: 12, title: "우유팩 터널 통과하기", desc: "우유팩 2~3개를 이어 붙여 터널을 만들고, 아기 주먹보다 큰 공을 굴려 통과시키며 '슝~' 소리를 내주세요.", effect: "👁️ 눈-손 협응력 발달" },
    { minM: 9, maxM: 12, title: "스티커 떼서 옮기기", desc: "엄마 손등의 큰 스티커를 떼서 아기 무릎으로 옮겨 붙이는 놀이를 해보세요.", effect: "🖐 정교한 소근육 발달" },
    { minM: 9, maxM: 12, title: "빈 통에 장난감 쏙쏙", desc: "빈 분유통이나 바구니에 블록이나 공을 '쏙!' 소리와 함께 넣고 빼보세요. 휴지심에 쏙 들어갈 만큼 작은 건 삼킬 수 있어 빼주세요.", effect: "🗑️ 공간 개념 및 조작 능력" },
    ...
    { minM: 9, maxM: 12, title: "장애물 넘기 코스", desc: "거실에 쿠션과 이불을 배치해 장애물을 만드세요. 엄마를 향해 넘어오게 유도하세요.", effect: "🏃‍♂️ 대근육 및 공간 인지" },
    { minM: 9, maxM: 12, title: "색깔 분류 놀이", desc: "빨간색 장난감과 파란색 장난감을 각각 다른 바구니에 담아보게 하세요.", effect: "🎨 인지 분류 능력" },
    /* 🆕 새로 추가된 9~12개월 놀이 */
    { minM: 9, maxM: 12, title: "벽에 붙은 장난감 구출", desc: "가벼운 인형을 마스킹 테이프로 벽(아기 눈높이)에 붙여두고 서서 떼어보게 하세요.", effect: "🧗 잡고 서기 연습 및 성취감" },
    { minM: 9, maxM: 12, title: "신문지 농구공 던지기", desc: "신문지를 마구 구겨서 공을 만든 뒤, 바닥에 둔 빨래바구니에 던져 넣게 유도하세요.", effect: "🏀 눈-손 협응력 및 팔 근육" },
    { minM: 9, maxM: 12, title: "반찬통 뚜껑 짝맞추기", desc: "모양과 크기가 다른 플라스틱 반찬통 2~3개를 주고 뚜껑을 닫아보게 하세요.", effect: "🧩 형태 인지 및 문제 해결" },
    { minM: 9, maxM: 12, title: "휴지심 안경으로 세상 보기", desc: "휴지심 2개를 눈에 대고 망원경처럼 보며 '우리 아기 어딨지~?' 하고 찾아보세요.", effect: "👀 시야의 변화 인지 및 유대감" },
    ...
    { minM: 13, maxM: 24, title: "이불 돌돌 김밥 말기", desc: "아기를 이불 위에 눕히고 '김밥 말자~' 하며 돌돌 말았다가 간지럼 태우며 풀어주세요. 얼굴은 꼭 이불 밖으로 내놓아요.", effect: "🍙 스킨십 및 신체 인지 능력" },
    ...
    { minM: 13, maxM: 24, title: "비치볼 배구", desc: "가벼운 비치볼이나 휴지를 뭉친 공을 떨어지지 않게 톡톡 치며 배구 놀이를 해보세요. 고무풍선은 터진 조각이 기도를 막을 수 있어 세 돌 전에는 피해요.", effect: "🎈 순발력 및 대근육 발달" },
    ...
    { minM: 13, maxM: 24, title: "테이프 길 만들기", desc: "바닥에 마스킹 테이프로 자동차 도로를 길게 그려주세요. 장난감 차를 굴려보게 하세요.", effect: "🚗 집중력 및 계획적 놀이" },
    { minM: 13, maxM: 24, title: "엄마/아빠 머리 꾸미기", desc: "아기용 핀이나 스카프를 엄마/아빠 머리에 꽂아보게 하세요. '너무 예쁘다!' 하며 거울을 보여주세요.", effect: "✨ 사회성 및 모방 놀이" },
    /* 🆕 새로 추가된 13~24개월 놀이 */
    { minM: 13, maxM: 24, title: "종이컵 전화기 여보세요", desc: "종이컵 2개를 실로 연결해 실 전화기를 만들고 방 끝에서 서로 대화를 나누어보세요.", effect: "📞 청각 집중력 및 언어 발달" },
    { minM: 13, maxM: 24, title: "아빠 다리 롤러코스터", desc: "아빠가 누워서 정강이 위에 아기를 비행기 태우듯 올리고 위아래로 슉슉 움직여주세요.", effect: "🎢 전정기관 자극 및 대근육" },
    { minM: 13, maxM: 24, title: "양말 짝꿍 찾아주세요", desc: "빨래 건조대에서 마른 양말들을 무더기로 놓고 같은 무늬 양말을 찾게 해보세요.", effect: "🧦 시각적 변별력 및 분류 능력" },
    { minM: 13, maxM: 24, title: "페트병 볼링", desc: "빈 페트병 5개를 세워두고 부드러운 공을 발로 차서 쓰러뜨리게 하세요.", effect: "🎳 대근육 조절 및 스트레스 해소" },
    { minM: 13, maxM: 24, title: "물티슈 바닥 청소반장", desc: "물티슈 한 장을 주고 엄마와 함께 바닥을 박박 닦는 흉내를 내며 청소 놀이를 해보세요.", effect: "✨ 생활 습관 모방 및 협동심" },
    ...
    /* 🆕 새로 추가된 25~36개월 놀이 */
    { minM: 25, maxM: 36, title: "방석 징검다리 건너기", desc: "거실 바닥에 방석이나 베개를 듬성듬성 깔아두고 바닥에 닿지 않게 점프해서 건너게 하세요.", effect: "🐸 전신 균형 감각 및 순발력" },
    { minM: 25, maxM: 36, title: "거울 보고 다양한 표정 짓기", desc: "거울 앞에서 '화난 표정!', '놀란 표정!', '슬픈 표정!'을 지으며 감정 표현을 연습하세요.", effect: "🎭 감정 인지 및 표현력 발달" },
    { minM: 25, maxM: 36, title: "인형 아플 때 밴드 붙여주기", desc: "애착 인형이 아프다고 상황극을 하며 스티커나 유아용 밴드를 직접 붙여 치료해 주게 하세요.", effect: "🩹 공감 능력 및 소근육 발달" },
    { minM: 25, maxM: 36, title: "집 안 보물찾기", desc: "아이가 좋아하는 인형이나 스티커를 소파 뒤, 쿠션 밑에 숨기고 찾아오게 하세요. 젤리·사탕처럼 목에 걸릴 수 있는 건 숨기지 않아요.", effect: "🗺️ 추리력 및 공간 탐색 능력" },
    { minM: 25, maxM: 36, title: "휴지심·빨대 기차 꿰기", desc: "휴지심 조각이나 짧게 자른 빨대를 운동화 끈에 꿰어 긴 기차를 만들어 보세요. 목에 거는 목걸이는 감길 수 있어 만들지 않아요.", effect: "📿 초집중력 및 눈-손 협응 심화" }
];
