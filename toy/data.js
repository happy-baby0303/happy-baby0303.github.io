...
const playData = [
    ...
    { 
        ...
        steps: [
            "1. 아빠가 방문 틀 사이에 박스테이프를 거미줄처럼 여러 겹(끈적이는 면이 아기를 향하게) 붙입니다.",
    ...
    { 
        ...
        steps: [
            ...
            "4. 빵빵한 공기 저항 덕분에 절대 다치지 않고 층간소음도 없습니다."
        ],
    ...
    { 
        ...
        desc: "변비로 며칠째 고생할 때 쓰는 최종 병기. 장을 마사지하고 촉감으로 신경을 깨웁니다.",
        steps: [
            "1. 아기를 욕조에 옷을 벗겨 앉힙니다. (따뜻한 물을 얕게 받거나 빈 욕조)",
            "2. 부드럽게 불린 미역이나 따뜻하게 데운 두부를 던져줍니다.",
            "3. 손으로 쥐어짜고 몸에 치덕치덕 바르며 완벽한 촉감놀이를 즐깁니다.",
            "4. 배에 힘을 주며 놀다가 자연스럽게 응가가 나올 확률이 90%입니다. (바로 물로 씻겨내면 끝!)"
        ],
    ...
    { 
        ...
        desc: "물감은 입에 들어갈까 걱정되죠? 먹어도 되고 쾌변까지 보장하는 요거트 촉감놀이.",
        steps: [
   ...
   { 
    ...
    { 
        ...
        desc: "목욕 물 받기 전 시간 떼우기 최고! 물 뿌리면 거품이 나면서 청소까지 한 번에 끝납니다.",
        steps: [
