...
const playData = [
    ...
    { 
        ...
        steps: [
            ...
            "2. 안 쓰는 손수건이나 자투리 천 5~6장을 끝과 끝을 묶어 길게 이어줍니다. (안전) 길게 이은 천은 목에 감길 수 있어요. 놀 때만 주고 끝나면 치워 주세요.",
    ...
    { 
        ...
        desc: "엄마 아파서 도저히 못 일어나는 날, 누워서 시간 때우는 전설의 눕육아.",
        steps: [
    ...
    { 
        ...
        steps: [
            ...
            "4. 테이프 사이에 아기가 좋아하는 장난감을 숨겨두면 더 오래 놉니다. (안전) 뜯은 테이프 조각은 입에 넣기 쉬우니 바로바로 치워 주세요."
        ],
    ...
    { 
        ...
        steps: [
            ...
            "4. 이불 속에서 안 나오는 엄마를 아기가 파헤치게 두세요. (안전) 아기가 이불 속으로 파고들면 얼굴이 덮이지 않게 바로 걷어 주세요."
        ],
        dadRole: "이불 세탁기 돌리기",
        relatedToyId: 67
    },
    ...
    { 
        ...
        steps: [
            ...
            "3. 엄마의 심장 소리와 숨쉴 때마다 오르락내리락하는 배의 움직임이 아기를 편안하게 해줍니다.",
            "4. 아기가 엄마 턱이나 코를 빨아먹으려 할 수 있으니 주의하며 15분을 버팁니다. (안전) 졸리면 바로 아기를 바닥에 등을 대고 눕혀 주세요. 아기를 가슴에 올린 채 잠들면 안 됩니다."
        ],
    ...
    { 
        ...
        steps: [
            ...
            "3. 이불을 아기 몸 위 한 뼘 높이에서 사르륵 내렸다 올렸다 반복합니다. (안전) 얼굴 위로는 떨어뜨리지 마세요. 이 개월수에는 스스로 걷어내지 못합니다.",
    ...
    { 
        ...
        steps: [
            ...
            "4. 살살 꼬집히는 것만 참으면 20분쯤 누워서 쉴 수 있어요. 눈은 감아도 잠들지는 마세요."
        ],
    ...
    { 
        ...
        desc: "촉각과 전정감각을 동시에 자극하는 아빠 전용 놀이. 웃음이 자주 터지는 놀이예요.",
        steps: [
            "1. 바닥에 큰 이불을 쭉 펼치고 그 끝에 아기를 눕힙니다.",
            "2. 아빠가 이불 끝을 잡고 천천히 굴려서 아기를 '김밥'처럼 둥글게 맙니다. (안전) 얼굴은 꼭 이불 밖으로, 너무 조이지 않게.",
    ...
    { 
        id: "p37", title: "[아플 때] 내 얼굴 TV 시청", category: "sick", targetAge: ['newborn', 'tummy', 'flip', 'crawl', 'stand'], 
    ...
    { 
        ...
        steps: [
            ...
            "3. 손으로 쪼물딱거리고 발로 밟고 입으로 쪽쪽 빨아먹으며 놉니다.",
    ...
    // 🚀 TRACK 1 확장팩: 야무진 생존 놀이 DB (p43 ~ p90)
    { 
        ...
        steps: [
            ...
            "3. 거실 바닥이나 유리창에 테이프로 지퍼락을 단단히 고정합니다.",
            "4. 아기가 손바닥으로 누르고 문지르며 색이 섞이는 걸 관찰하게 둡니다."
        ],
        dadRole: "놀이 끝난 후 터지기 전에 지퍼락 안전하게 쓰레기통으로 폐기하기",
        relatedToyId: null
    },
    { 
        id: "p44", title: "테이크아웃 컵 빨대 꽂기", category: "zero", targetAge: ['stand'], 
        targetItem: "카페 플라스틱 컵(뚜껑 포함), 빨대 여러 개", energyDrain: "🔥🔥 (소근육 핀셋 훈련)", playTime: 20,
        desc: "카페 다녀온 날 필수 뚜껑의 작은 십자 구멍에 빨대를 꽂으며 엄청난 집중력과 침을 흘립니다.",
        steps: [
            "1. 깨끗이 씻은 테이크아웃 플라스틱 컵과 뚜껑을 준비합니다.",
            "2. 아기에게 빨대 여러 개를 쥐여줍니다. (안전) 면봉은 쓰지 마세요. 빨대를 입에 문 채 기어 다니지 않게 옆에서 봐주세요.",
            "3. 엄마가 먼저 뚜껑 구멍에 빨대를 쏙 넣는 모습을 보여줍니다.",
            "4. 아기가 입을 삐죽 내밀고 구멍에 빨대를 넣기 위해 초집중하는 모습을 감상하세요."
        ],
        dadRole: "카페에서 커피 마시고 컵 씻어서 말려두기",
        relatedToyId: null
    },
    { 
        id: "p45", title: "빨래건조대 비밀 아지트", category: "zero", targetAge: ['crawl', 'stand'], 
        targetItem: "빨래건조대, 큰 이불, 랜턴(옵션)", energyDrain: "🔥🔥 (상상력 자극)", playTime: 30,
        desc: "빨래 걷기 귀찮은 날, 그냥 그 위에 이불을 덮어버리세요. 최고의 텐트가 됩니다.",
        steps: [
            "1. Y자형 빨래건조대 위에 크고 어두운 이불을 덮어 텐트를 만듭니다.",
            "2. 한쪽을 열어 출입구를 만들고, 바닥에 푹신한 매트와 애착 인형들을 넣어줍니다.",
            "3. 아기가 건조대 밑으로 기어 들어가 자기만의 공간에서 놀게 둡니다.",
            "4. 안쪽에 작은 랜턴이나 튤립 사운드북을 켜주면 30분 동안 안 나옵니다."
        ],
        dadRole: "퇴근 후 아지트(건조대) 해체하고 진짜 빨래 널기",
        relatedToyId: null
    },
    { 
        ...
        steps: [
            "1. 지퍼가 크고 부드럽게 움직이는 아빠의 겨울 패딩이나 백팩을 준비합니다.",
            "2. 아기 눈높이 바닥에 두고, 지퍼를 끝까지 올렸다 내리는 찌익- 소리를 들려줍니다.",
            "3. 아기가 직접 지퍼 손잡이를 잡고 올리고 내리는 쾌감에 빠지게 둡니다.",
            "4. 지퍼 안에 아기가 좋아하는 작은 장난감을 숨겨두면 까꿍 놀이로 연장됩니다."
        ],
        dadRole: "안 입는 아빠 패딩 기부하기",
        relatedToyId: null
    },
    { 
    ...
    { 
        id: "p48", title: "박스테이프 거미줄 농구장", category: "dad", targetAge: ['stand'], 
        targetItem: "투명 박스테이프, 양말공이나 가벼운 볼풀공", energyDrain: "🔥🔥🔥🔥 (어깨/투구 훈련)", playTime: 20,
        desc: "비 와서 밖에서 못 뛰어놀 때, 방문 틀 하나로 끝내는 아빠의 실내 체육관.",
        steps: [
            "1. 아빠가 방문 틀 사이에 박스테이프를 거미줄처럼 여러 겹(끈적이는 면이 아기를 향하게) 붙입니다. (안전) 아기 얼굴보다 높은 곳에 붙이고, 놀이가 끝나면 바로 떼어 주세요.",
            "2. 양말을 둥글게 말거나 볼풀공을 준비합니다.",
            "3. 아기가 공을 던져 끈적이는 테이프 거미줄에 '착' 하고 붙이게 합니다.",
            "4. 목표물에 적중하는 쾌감 때문에 땀을 뻘뻘 흘리며 공을 던집니다."
        ],
        dadRole: "거미줄 설치 & 바닥에 떨어진 양말공 무한 픽업 셔틀",
        relatedToyId: 71
    },
    { 
        id: "p49", title: "아빠 다리 엘리베이터", category: "dad", targetAge: ['tummy', 'flip'], 
        targetItem: "아빠의 튼튼한 종아리", energyDrain: "🔥🔥🔥 (아빠 하체 운동)", playTime: 10,
        desc: "비행기 태우기는 허리가 아프지만, 이건 아빠가 누워서 스마트폰을 보며 하체 운동을 할 수 있습니다.",
        steps: [
            "1. 아빠는 거실 바닥에 등을 대고 눕고, 무릎을 세워 다리를 직각(ㄱ자)으로 만듭니다.",
            "2. 아빠의 정강이 위에 아기를 배를 깔고 비행기 타듯 엎드려 올려놓습니다.",
            "3. 아빠가 다리를 위아래로 올렸다 내리며 엘리베이터 효과음을 냅니다.",
            "4. 아기는 떨어지지 않으려 중심을 잡으며 코어 근육이 폭발적으로 발달합니다."
        ],
        dadRole: "10분 동안 쉬지 않고 하체 레그레이즈 운동하기",
        relatedToyId: null
    },
    { 
        ...
        steps: [
            ...
            "3. 아기가 달려와서 거대 비닐 풍선을 주먹으로 치고 몸으로 부딪히며 놉니다.",
            "4. 층간소음 없이 한참 부딪히며 놉니다. (안전) 비닐이 터지거나 바람이 빠지면 바로 치우세요. 비닐은 얼굴을 덮으면 숨을 막습니다. 놀고 나면 아기 손이 안 닿는 곳에 버려 주세요."
        ],
        dadRole: "인간 샌드백 지지대 되어주기 (맞을 때마다 리얼한 소리 내기)",
        relatedToyId: null
    },
    { 
        ...
        steps: [
            ...
            "3. 아기가 기어 와서 엄마 얼굴 위(이마, 볼, 코)에 포스트잇을 맘대로 붙이게 합니다.",
            "4. 엉뚱한 데 붙일 때마다 '어푸푸' 소리 한 번 내주면 한참을 뗐다 붙였다 합니다."
        ],
        dadRole: "엄마 얼굴에 포스트잇 눈코입 예쁘게 그려주고 가기",
        relatedToyId: 21
    },
    { 
        id: "p52", title: "[눕육아] 발바닥 하이파이브", category: "lieDown", targetAge: ['newborn', 'tummy'], 
        targetItem: "엄마의 손바닥", energyDrain: "🔥 (팔만 뻗기)", playTime: 10,
        desc: "배앓이 방지(장운동)와 눕육아를 동시에 해결하는 신생아 전용 놀이.",
        steps: [
            "1. 아기를 매트 위에 눕히고, 엄마는 아기 발치에 마주 보고 눕습니다.",
            "2. 엄마 손바닥을 아기 발바닥 쪽에 가볍게 댑니다.",
            "3. 아기가 무의식적으로 발로 엄마 손을 뻥뻥 찹니다. (반사 신경)",
            "4. 찰 때마다 '하이파이브', '나이스킥' 해주면 아기 허벅지 힘이 폭발합니다."
        ],
        dadRole: "아기 눕히고 기저귀 갈아준 뒤 엄마랑 바통 터치",
        relatedToyId: null
    },
    { 
        id: "p53", title: "욕실 두부/미역 폭주족", category: "poop", targetAge: ['crawl', 'stand'], 
        targetItem: "불린 미역 또는 유통기한 지난 두부, 욕조", energyDrain: "🔥🔥🔥 (치우기 빡셈)", playTime: 30,
        desc: "변비로 며칠째 고생할 때 해볼 만한 촉감놀이. 따뜻한 두부와 미역을 주무르며 놉니다.",
        steps: [
            "1. 아기를 욕조에 옷을 벗겨 앉힙니다. (따뜻한 물을 얕게 받거나 빈 욕조)",
            "2. 부드럽게 불린 미역이나 따뜻하게 데운 두부를 던져줍니다.",
    ...
    { 
        id: "p54", title: "슈퍼맨 방귀 체조", category: "poop", targetAge: ['tummy', 'flip'], 
        targetItem: "푹신한 매트", energyDrain: "🔥 (팔 운동)", playTime: 5,
        desc: "하늘 자전거로도 가스가 안 빠질 때 쓰는 가스 배출(방귀) 직빵 체조.",
        steps: [
            "1. 아기를 하늘을 보게 눕히고, 양쪽 발목을 잡습니다.",
            "2. 두 다리를 동시에 아기 배 쪽으로 꾹 눌러줍니다. (무릎이 명치 쪽을 향하게)",
            "3. 3초간 지그시 눌렀다가 다리를 쭉 펴줍니다.",
            "4. 5~10회 반복하면 뱃속에 고여있던 가스가 '뿌웅' 하고 나옵니다."
        ],
        dadRole: "체조 중 방귀 냄새나면 과장되게 기절하는 연기하기",
        relatedToyId: null
    },
    { 
        id: "p55", title: "야광별 멍때리기 캠핑", category: "sick", targetAge: ['flip', 'crawl', 'stand'], 
        targetItem: "다이소 야광 스티커, 안방", energyDrain: "0 (안고 진정시키기)", playTime: 15,
        desc: "원더윅스 기간, 뇌가 과부하 걸려서 뽀로로도 거부할 때 시각을 차단하고 진정시킵니다.",
        steps: [
            "1. 다이소에서 파는 야광 스티커를 안방 천장에 미리 붙여둡니다.",
            "2. 악쓰고 우는 아기를 안고 방에 들어와 불을 완전히 끕니다.",
            "3. 천장에 빛나는 야광별을 가리키며 작고 낮은 목소리로 '우와, 별이네~' 속삭입니다.",
            "4. 차분한 빛을 보며 아기의 흥분된 뇌파가 가라앉고 스르륵 눈을 감습니다."
        ],
        dadRole: "사다리 타고 안방 천장에 야광별 예쁘게 세팅해두기",
        relatedToyId: 15
    },
    { 
    ...
    { 
        id: "p57", title: "꼬꼬맘/에듀테이블 터널 탈출", category: "toy", targetAge: ['crawl'], 
        targetItem: "꼬꼬맘 또는 에듀테이블, 빨래바구니(또는 상자)", energyDrain: "🔥🔥 (기어가기 극대화)", playTime: 20,
        desc: "장난감에 질려서 쳐다도 안 볼 때, 박스나 바구니 밑에 숨겨서 청각적 호기심을 유발합니다.",
        steps: [
            "1. 소리가 나는 장난감을 켜둔 상태로 큰 빨래바구니나 종이상자로 덮어버립니다.",
            "2. 장난감이 안 보이고 소리만 웅웅 나게 만듭니다.",
            "3. 아기가 기어 와서 '어? 소리가 어디서 나지?' 하며 바구니를 뒤집어엎습니다.",
            "4. 갇혀있던 꼬꼬맘이 튀어나오면 까꿍 놀이보다 10배 좋아합니다."
        ],
        dadRole: "안 쓰는 큰 종이상자로 맞춤형 감옥(덮개) 만들어주기",
        relatedToyId: 41
    },
    { 
        ...
        steps: [
            ...
            "3. '택배 왔습니다~' 하면 아기가 쪼그려 앉아 양말을 줍고 다시 일어납니다.",
            "4. 아기가 양말을 다시 엄마 쪽으로 던져 넣으며 무한 하체 스쿼트를 시전합니다."
        ],
        dadRole: "문짝 넘어지지 않게 뒤에서 잡아주며 택배 받아주기",
        relatedToyId: 7
    },
    { 
        id: "p59", title: "탁구공 파도타기", category: "zero", targetAge: ['tummy', 'flip'], 
        targetItem: "탁구공(또는 볼풀공), 헤어드라이어", energyDrain: "🔥 (시각추적)", playTime: 10, 
        desc: "드라이어 바람으로 공을 허공에 띄우는 마술 터미타임 하는 아기의 눈이 휘둥그레집니다.", 
        steps: [
            "1. 헤어드라이어를 '냉풍(약)'으로 켭니다.", 
            "2. 바람 위로 가벼운 탁구공이나 볼풀공을 올리면 허공에 둥둥 뜹니다.", 
            "3. 아기가 신기해서 손을 뻗어 공을 낚아채려고 용을 씁니다."
        ], 
        dadRole: "드라이기 들고 마술사 연기하기", 
        relatedToyId: null 
    },
    { 
        id: "p60", title: "이불 썰매장 (거실 바닥 청소)", category: "dad", targetAge: ['crawl', 'stand'], 
        targetItem: "도톰한 수건이나 이불", energyDrain: "🔥🔥🔥🔥 (아빠 허리 갈림)", playTime: 15, 
        desc: "바구니 썰매의 응용 버전. 거실 바닥 물걸레질을 핑계로 아기와 놀아줍니다.", 
        steps: [
            "1. 바닥에 큰 수건이나 이불을 깔고 아기를 앉힙니다.", 
            "2. 아빠가 이불 끝을 잡고 썰매 끌듯 온 거실을 누빕니다.", 
            "3. '우회전~ 좌회전~' 하며 코너링을 해주면 스릴 만점입니다."
        ], 
        dadRole: "루돌프", 
        relatedToyId: null 
    },
    { 
        id: "p61", title: "[눕육아] 다리 터널 기차", category: "lieDown", targetAge: ['crawl'], 
        targetItem: "장난감 기차나 미니카", energyDrain: "0", playTime: 15, 
        desc: "엄마가 누워서 다리만 ㅅ자로 세워주면 그곳이 바로 훌륭한 터널이 됩니다.", 
        steps: [
            "1. 바닥에 누워 무릎을 굽히고 다리를 벌려 터널을 만듭니다.", 
            "2. 아기에게 미니카를 주고 터널 안으로 굴려 통과시키게 합니다.", 
            "3. 통과할 때마다 '터널 무너진다' 하며 무릎을 살짝 조여줍니다."
        ], 
        dadRole: "터널 통과한 미니카 다시 아기한테 주워다 주기", 
        relatedToyId: 46 
    },
    { 
        id: "p62", title: "쌀통 숨바꼭질", category: "zero", targetAge: ['stand'], 
        targetItem: "쟁반, 쌀 한 컵, 작은 장난감", energyDrain: "🔥🔥 (촉감/소근육)", playTime: 20, 
        ...
        dadRole: "바닥에 흘린 쌀알 청소기 돌리기", 
        relatedToyId: null 
    },
    { 
        id: "p63", title: "창문 거품 스케치북", category: "zero", targetAge: ['stand'], 
        targetItem: "아기용 바스 거품", energyDrain: "🔥🔥 (서서 놀기)", playTime: 20, 
        desc: "목욕 전 화장실이나 베란다 유리창에 거품을 칠해 마음껏 그림을 그리게 합니다.", 
        steps: [
            "1. 거품을 많이 내서 유리창에 치덕치덕 발라줍니다.", 
            "2. 아기가 손가락으로 거품을 문지르며 그림을 그리고 놉니다.", 
            "3. 다 놀고 나면 샤워기로 한 번에 물을 뿌려 청소까지 끝냅니다."
        ], 
        dadRole: "유리창 뽀득뽀득하게 닦아서 마무리하기", 
        relatedToyId: 42 
    },
    { 
        id: "p64", title: "[눕육아] 발바닥 비행기 조종사", category: "lieDown", targetAge: ['stand'], 
        targetItem: "엄마 발", energyDrain: "🔥", playTime: 10, 
        desc: "누워서 다리만 위로 뻗어 아기가 서서 조종하게 만드는 놀이.", 
        steps: [
            "1. 엄마는 하늘을 보고 누워 다리를 직각으로 올립니다.", 
            "2. 서 있는 아기가 엄마의 발바닥을 손으로 밀고 당기게 합니다.", 
            "3. 아기 힘에 맞춰 다리를 까딱거리며 조종당하는 척을 해줍니다."
        ], 
        dadRole: "엄마 발목 꺾이지 않게 뒤에서 봐주기", 
        relatedToyId: null 
    },
    { 
        id: "p65", title: "페트병 볼링", category: "dad", targetAge: ['crawl', 'stand'], 
        targetItem: "빈 생수병 3~5개, 볼풀공", energyDrain: "🔥🔥 (목표 조준)", playTime: 15, 
        desc: "마시고 남은 페트병만 세워두면 거실이 훌륭한 볼링장으로 변합니다.", 
        steps: [
            "1. 빈 생수병 여러 개를 거실 끝에 삼각형 모양으로 세웁니다.", 
            "2. 아기에게 볼풀공이나 둥글게 만 양말을 줍니다.", 
            "3. 굴리거나 던져서 페트병을 쓰러뜨릴 때마다 환호성을 질러줍니다."
        ], 
        dadRole: "쓰러진 핀(페트병) 빛의 속도로 다시 세팅하기", 
        relatedToyId: null 
    },
    { 
        id: "p66", title: "손전등 귀신 잡기", category: "dad", targetAge: ['crawl', 'stand'], 
        targetItem: "손전등(스마트폰 플래시)", energyDrain: "🔥🔥🔥 (추격전)", playTime: 15, 
        desc: "불 끄고 자야 하는데 안 잘 때 불을 끄는 대신 손전등으로 유인합니다.", 
        steps: [
            "1. 방 불을 다 끄고 스마트폰 플래시를 켭니다.", 
            "2. 바닥에 빛을 쏘고 요리조리 움직이며 아기가 빛을 잡으러 기어오게 합니다.", 
            "3. 고양이 낚시질하듯 이리저리 에너지를 쏙 뺀 뒤 자연스럽게 침대에 눕힙니다."
        ], 
        dadRole: "빛의 마술사 되어 이리저리 플래시 쏘기", 
        relatedToyId: null 
    },
    { 
        id: "p67", title: "냄비 드럼 연주회", category: "zero", targetAge: ['stand'], 
        targetItem: "안 깨지는 냄비, 실리콘 주걱", energyDrain: "🔥🔥 (리듬/스트레스 해소)", playTime: 20, 
        desc: "층간소음이 걱정 없는 낮 시간 한정판. 주방 도구를 내어주면 최고의 악기가 됩니다.", 
        steps: [
            "1. 바닥에 냄비 2~3개와 플라스틱 그릇을 엎어놓습니다.", 
            "2. 실리콘 주걱이나 나무젓가락을 아기에게 쥐여줍니다.", 
            "3. 냄비마다 다른 소리가 나는 걸 즐기며 미친 듯이 두드리게 둡니다."
        ], 
        dadRole: "시끄러워도 참아주기", 
        relatedToyId: null 
    },
    { 
        id: "p68", title: "[좀비모드] 등에 과자 올리고 버티기", category: "lieDown", targetAge: ['crawl'], 
        targetItem: "아기 떡뻥", energyDrain: "0", playTime: 10, 
        desc: "엄마 등에 과자를 올려두면 아기가 등에서 밥을 먹는 평화가 찾아옵니다.", 
        steps: [
            "1. 엄마는 바닥에 엎드려서 휴식을 취합니다.", 
            "2. 엄마 등 위에 아기가 좋아하는 과자나 떡뻥을 올려둡니다.", 
            "3. 아기가 기어 와서 엄마 등 위에서 조용히 과자를 집어 먹습니다."
        ], 
        dadRole: "등에 부스러기 떨어진 거 돌돌이로 밀어주기", 
        relatedToyId: null 
    },
    { 
        id: "p69", title: "박스 속 미로 탈출", category: "zero", targetAge: ['crawl'], 
        targetItem: "큰 택배 박스 2개", energyDrain: "🔥🔥 (대근육)", playTime: 20, 
        desc: "택배 온 날 버리지 말고 터널로 연결해 주면 키즈카페 부럽지 않습니다.", 
        steps: [
            "1. 큰 택배 박스의 위아래 뚜껑을 모두 열어 기둥 형태로 만듭니다.", 
            "2. 박스 2~3개를 테이프로 이어 붙여 긴 터널을 만듭니다.", 
            "3. 반대편에서 까꿍을 해주면 아기가 박스를 통과하며 대근육을 씁니다."
        ], 
        dadRole: "분리수거 날 박스 해체해서 버리기", 
        relatedToyId: null 
    },
    { 
        id: "p70", title: "스티커 세안 (얼굴에 스티커 떼기)", category: "sick", targetAge: ['stand'], 
        targetItem: "스티커북", energyDrain: "0 (초집중)", playTime: 20, 
        desc: "약 먹기 싫어하거나 짜증 낼 때, 아기 손등이나 발등에 스티커를 붙여 시선을 분산시킵니다.", 
        steps: [
            "1. 아기가 좋아하는 캐릭터 스티커를 아기 손등, 발등, 다리에 붙여줍니다.", 
            "2. '앗 발에 벌레가 붙었네 떼어주세요' 하고 과장되게 말합니다.", 
            "3. 아기가 자기 몸에 붙은 스티커를 떼어내며 소근육을 쓰고 집중력을 발휘합니다."
        ], 
        dadRole: "스티커 찢어지지 않게 미리 반쯤 떼어놔 주기", 
        relatedToyId: null 
    },
    { 
        id: "p71", title: "욕실 벽 물총 과녁 맞추기", category: "bath-care", targetAge: ['stand'], 
        targetItem: "물총(또는 샴푸통), 욕실", energyDrain: "🔥🔥 (조준 훈련)", playTime: 20, 
        desc: "목욕탕에서 안 나가려고 할 때 체력을 완전히 고갈시키는 훈련입니다.", 
        steps: [
            "1. 욕실 벽 타일에 물감이나 비누 거품으로 과녁(X자)을 그려줍니다.", 
            "2. 다 쓴 샴푸통이나 물총에 물을 채워줍니다.", 
            "3. 아기가 물을 쏘아서 과녁의 거품을 씻어내게 만듭니다."
        ], 
        dadRole: "샴푸통에 물 무한 리필해주기", 
        relatedToyId: 90 
    },
    { 
        id: "p72", title: "휴지 뽑기 하이라이트", category: "zero", targetAge: ['flip', 'crawl'], 
        targetItem: "반쯤 남은 두루마리 휴지", energyDrain: "🔥🔥 (무한 쾌감)", playTime: 10, 
        desc: "물티슈 아까워서 못 하게 했던 뽑기 놀이, 저렴한 두루마리 휴지로 플렉스하게 해주세요.", 
        steps: [
            "1. 어차피 청소할 때 쓸 저렴한 두루마리 휴지를 통째로 줍니다.", 
            "2. 아기가 양손으로 휴지를 미친 듯이 뜯고 풀게 내버려 둡니다.", 
            "3. 방 안이 휴지 바다가 되는 동안 아기의 스트레스는 0이 됩니다. (나중에 뭉쳐서 버리면 끝)"
        ], 
        dadRole: "풀어진 휴지 뭉쳐서 창틀 청소나 기름기 닦는 데 쓰기", 
        relatedToyId: null 
    },
    { 
        id: "p73", title: "어둠 속 소리 숨바꼭질", category: "zero", targetAge: ['crawl', 'stand'], 
        targetItem: "코코지 하우스(또는 핸드폰 동요), 이불", energyDrain: "🔥🔥 (청각 집중/추리)", playTime: 20,
        desc: "청각이 예민해지는 시기, 눈으로 찾는 게 아니라 귀로 찾는 숨바꼭질입니다.",
        steps: [
            "1. 동요가 나오는 장난감(코코지 하우스 등)이나 핸드폰을 켭니다.",
            "2. 아기가 못 보게 이불 밑이나 베개 뒤에 살짝 숨겨둡니다.",
            "3. '어? 소리가 어디서 나지?' 하며 아기가 기어 다니며 소리의 진원지를 찾게 합니다.",
            "4. 장난감을 찾아내면 폭풍 칭찬을 해주고, 다시 다른 곳에 숨겨 반복합니다."
        ],
        dadRole: "교묘한 위치에 장난감 숨기고 모르는 척 연기하기",
        relatedToyId: 94
    },
    { 
        id: "p74", title: "꿀벌 쿵 장애물 피하기", category: "dad", targetAge: ['stand'], 
        targetItem: "머리쿵 방지 쿠션, 베개 여러 개", energyDrain: "🔥🔥🔥 (균형 감각/하체)", playTime: 20,
        desc: "막 서기 시작해서 잘 넘어질 때, 아예 안전한 환경을 만들고 균형 감각을 키워줍니다.",
        steps: [
            "1. 아기 등 뒤에 머리쿵 방지 쿠션을 메어줍니다. (방어력 +100)",
            "2. 거실 매트 위에 푹신한 베개나 이불을 듬성듬성 놓아 장애물 코스를 만듭니다.",
            "3. 아빠가 반대편에서 장난감을 흔들며 아기가 베개를 밟고 넘어오게 유도합니다.",
            "4. 뒤로 엉덩방아를 찧어도 꿀벌 쿠션 덕분에 아프지 않아 꺄르르 웃습니다."
        ],
        dadRole: "장애물 코스 설계 및 도착 시 격하게 안아주기",
        relatedToyId: 95
    },
    { 
        id: "p75", title: "천장 그림자 동물원", category: "sick", targetAge: ['newborn', 'tummy', 'flip'], 
        targetItem: "그림자 극장 장난감 (또는 플래시)", energyDrain: "0 (안구 추적/진정)", playTime: 15,
        desc: "열이 나거나 아파서 몸을 쓰면 안 될 때, 누워서 뇌를 쉬게 해주는 수면 유도 놀이.",
        steps: [
            "1. 방의 불을 완전히 끄고 아기와 나란히 눕습니다.",
            "2. 두두스토리 그림자 극장이나 스마트폰 플래시를 천장에 쏩니다.",
            "3. 그림자가 움직이는 걸 보며 나지막하고 차분한 목소리로 동화를 읽어줍니다.",
            "4. 시각적 자극이 낮아 아기의 흥분된 뇌파가 가라앉고 잠에 빠져듭니다."
        ],
        dadRole: "옆에 누워서 저음의 목소리로 동화 나레이션 해주기",
        relatedToyId: 96
    },
    { 
    ...
    { 
        id: "p78", title: "거꾸로 물 마시기 (빨대컵 훈련)", category: "zero", targetAge: ['flip', 'crawl'], 
        targetItem: "추 달린 빨대컵, 물 약간", energyDrain: "🔥 (구강 근육 발달)", playTime: 10,
        desc: "이유식을 먹으려면 사레들리지 않고 물을 삼키는 구강 근육 훈련이 필수입니다.",
        steps: [
            "1. 안 새는 추 빨대컵에 물이나 보리차를 조금만 담습니다.",
            "2. 아기를 소파나 매트에 비스듬히 눕히고 빨대컵을 쥐여줍니다.",
    ...
    { 
        id: "p79", title: "공사장 모래 싣기", category: "toy", targetAge: ['stand'], 
        targetItem: "포크레인 장난감, 뻥튀기(또는 편백나무 큐브)", energyDrain: "🔥🔥 (집중/역할놀이)", playTime: 30,
        desc: "비싼 중장비 장난감, 허공에 헛삽질만 하지 말고 진짜 실어 나를 걸 주세요.",
        steps: [
            "1. 큰 쟁반 위에 부수기 쉬운 뻥튀기나 볼풀공(편백 큐브)을 잔뜩 깔아줍니다.",
            "2. 포크레인이나 덤프트럭 장난감을 줍니다.",
            "3. 아기가 포크레인 삽으로 뻥튀기를 퍼서 트럭에 옮겨 싣는 '공사장 놀이'에 몰입합니다.",
            "4. 떨어뜨린 뻥튀기를 주워 먹으면서 자연스럽게 30분이 순삭됩니다."
        ],
        dadRole: "같이 바닥에 엎드려서 중장비 엔진 소리(우루룽) 입으로 내주기",
        relatedToyId: 100
    },
    { 
        id: "p80", title: "[눕육아] 인간 샌드위치 압박", category: "lieDown", targetAge: ['crawl', 'stand'], 
        targetItem: "두꺼운 겨울 이불이나 쿠션", energyDrain: "0 (심리적 안정감)", playTime: 15,
        desc: "아기들은 약간 무거운 것으로 꾹꾹 눌러주면(심압) 자궁 속처럼 평온함을 느낍니다.",
        steps: [
            "1. 아기를 푹신한 매트 위에 엎드리게 합니다.",
            "2. 아기 등 위로 두꺼운 겨울 이불이나 큰 쿠션을 덮어 '샌드위치'를 만듭니다.",
            "3. 엄마가 그 위를 손바닥으로 체중을 실어 꾹꾹, 부드럽게 눌러 마사지합니다.",
            "4. '치즈 넣고~ 햄 넣고~ 꾹꾹' 해주면 아기가 시원해서 가만히 엎드려 있습니다."
        ],
        dadRole: "엄마 대신 아빠의 넓은 손으로 온몸 골고루 마사지해주기",
        relatedToyId: null
    },
    { 
        id: "p81", title: "우산 속 빗소리 텐트", category: "zero", targetAge: ['crawl', 'stand'], 
        targetItem: "큰 우산(투명 추천), 분무기", energyDrain: "🔥 (시각/청각/낭만)", playTime: 15,
        desc: "밖에 비가 올 때 집 안에서 낭만적으로 비를 맞는 최고의 오감 놀이.",
        steps: [
            "1. 거실 바닥에 수건을 깔고, 아기를 앉힌 뒤 커다란 우산을 씌워줍니다.",
            "2. 엄마가 우산 밖에서 분무기로 우산 위를 향해 물을 칙칙 뿌려줍니다.",
            "3. 우산 위로 물방울이 떨어지는 소리(토도독)와 물이 흐르는 걸 보며 아기가 즐거워합니다.",
            "4. 투명 우산이면 엄마와 눈을 맞출 수 있어 더욱 좋습니다."
        ],
        dadRole: "놀이 끝난 후 우산 펼쳐서 화장실에 말려두기",
        relatedToyId: null
    },
    { 
        id: "p82", title: "휴지 나풀나풀 캐치", category: "zero", targetAge: ['flip', 'crawl'], 
        targetItem: "곽티슈 (갑티슈) 2~3장", energyDrain: "🔥🔥 (안구 추적/순발력)", playTime: 10,
        desc: "누워있거나 앉아있는 아기 위로 휴지가 깃털처럼 떨어지는 걸 잡는 놀이.",
        steps: [
            "1. 갑티슈에서 휴지를 한 장 뽑아 아기 머리 위 높이 듭니다.",
            "2. 손에서 휴지를 놓아 사르르 떨어지게 합니다.",
            "3. 아기가 떨어지는 휴지를 눈으로 좇다가 두 손으로 팍 낚아채려고 합니다.",
            "4. 얼굴에 살포시 떨어져도 부드러워서 까르르 웃습니다."
        ],
        dadRole: "떨어진 휴지 모아서 아빠 얼굴 닦기",
        relatedToyId: null
    },
    { 
        id: "p83", title: "욕실 스팀 사우나 (코막힘 뻥)", category: "sick", targetAge: ['newborn', 'tummy', 'flip', 'crawl'], 
        targetItem: "따뜻한 샤워기", energyDrain: "0 (안고 호흡하기)", playTime: 15,
        desc: "감기 걸려서 코가 막히고 쌕쌕거릴 때 코를 뚫어주는 소아과 선생님 추천 요법.",
        steps: [
            "1. 화장실 문을 닫고 뜨거운 물을 샤워기로 5분간 틀어 욕실을 수증기로 가득 채웁니다.",
            "2. 뜨거운 물은 끄고(아기 화상 주의), 콧물이 꽉 막힌 아기를 안고 욕실로 들어갑니다.",
            "3. 수증기 가득한 화장실 안에서 10~15분 정도 아기를 안고 토닥거리며 앉아 있습니다.",
            "4. 따뜻한 습기가 코 점막을 촉촉하게 만들어 끈적한 콧물이 스르륵 녹아내립니다."
        ],
        dadRole: "미리 화장실 뜨거운 물 틀어서 스팀 꽉 채워두기",
        relatedToyId: 87
    },
    { 
        id: "p84", title: "얼굴에 바람 후~ 불기", category: "zero", targetAge: ['newborn', 'tummy'], 
        targetItem: "엄마의 입바람", energyDrain: "0 (폐활량 약간)", playTime: 5,
        desc: "신생아 딸꾹질 멈추게 할 때, 또는 웃음보 터뜨릴 때 쓰는 초간단 놀이.",
        steps: [
            "1. 아기와 얼굴을 20cm 정도 간격으로 마주 봅니다.",
            "2. 아기 이마나 볼, 머리카락을 향해 입으로 '후~' 하고 바람을 짧게 붑니다.",
            "3. 아기가 깜짝 놀라며 눈을 깜빡거리다가 숨을 크게 들이마십니다. (딸꾹질 멈춤 효과)",
            "4. 바람과 함께 '까꿍' 해주면 방긋방긋 웃습니다."
        ],
        dadRole: "입 냄새 안 나게 양치질하고 바람 불어주기",
        relatedToyId: null
    },
    { 
        ...
        steps: [
            ...
            "2. 차갑지 않게 상온에 둔 요거트를 아기 앞 바닥에 푹 짜줍니다.",
            "3. 손으로 문지르고, 배에 바르고, 입으로 쪽쪽 빨아먹게 둡니다.",
            "4. 유산균 섭취와 촉감놀이를 동시에 끝내고 바로 목욕탕으로 직행합니다."
        ],
        dadRole: "놀이 끝난 후 비닐 걷어내고 바닥 물걸레질 빡세게 하기",
        relatedToyId: null
    },
    { 
        id: "p86", title: "거울 뽀뽀 (거울 속 나애게)", category: "zero", targetAge: ['flip', 'crawl'], 
        targetItem: "전신거울", energyDrain: "🔥 (자아 인지 발달)", playTime: 10,
        desc: "거울 속 아기가 자신인지 모르는 시기, 최고의 친구를 만들어줍니다.",
        steps: [
            "1. 아기를 안고 큰 전신거울 앞에 섭니다.",
            "2. 거울 속 아기에게 '안녕? 반가워' 하며 손을 흔들어 줍니다.",
            "3. 아기가 거울에 다가가 입을 맞추거나(뽀뽀) 손으로 치며 신기해합니다.",
            "4. 아기 뒤에서 까꿍 놀이를 해주면 거울을 통한 공간 지각력이 생깁니다."
        ],
        dadRole: "거울에 묻은 아기 침 자국 유리세정제로 깨끗이 닦기",
        relatedToyId: null
    },
    { 
        id: "p87", title: "아빠 다리 톨게이트 기어가기", category: "dad", targetAge: ['crawl'], 
        targetItem: "아빠의 긴 다리, 장난감 자동차", energyDrain: "🔥🔥 (아빠 코어 운동)", playTime: 15,
        desc: "배밀이와 기어가기 속도를 마하 1로 올려주는 톨게이트 놀이.",
        steps: [
            "1. 아빠는 거실 바닥에 엎드려뻗쳐(플랭크) 자세나 다리를 넓게 벌린 엎드린 자세를 합니다.",
            "2. '톨게이트 열립니다~' 하면서 공간을 확보해줍니다.",
            "3. 아기가 미니카를 들고 그 밑을 빛의 속도로 기어 통과하게 합니다.",
            "4. 통과할 때 아빠 배가 살짝 아기 등에 닿으면 꺄르르 넘어갑니다."
        ],
        dadRole: "버티는 동안 코어(복근) 힘 꽉 주고 운동 효과 누리기",
        relatedToyId: 46
    },
    { 
        id: "p88", title: "페트병 마이크 가수왕", category: "zero", targetAge: ['stand'], 
        targetItem: "빈 생수병", energyDrain: "🔥 (발성 연습)", playTime: 10,
        desc: "옹알이가 폭발할 때, 자기 목소리가 울리는 걸 들려주어 언어 발달을 돕습니다.",
        steps: [
            "1. 빈 500ml 생수병(깨끗하게 말린 것)을 아기 입가에 대줍니다.",
            "2. 엄마가 먼저 입구에 대고 '아~ 에~ 이~' 하며 울리는 소리를 냅니다.",
            "3. 아기가 따라 병 입구에 대고 소리를 냈을 때, 울리는 메아리에 깜짝 놀라며 재밌어합니다.",
            "4. 온갖 돌고래 소리를 내며 혼자만의 콘서트를 엽니다."
        ],
        dadRole: "콘서트 관람객 1호가 되어 미친 듯이 박수 쳐주기",
        relatedToyId: null
    },
    { 
        id: "p89", title: "이불 썰매 (수건 끌기)", category: "dad", targetAge: ['tummy', 'flip'], 
        targetItem: "도톰한 수건 1장", energyDrain: "🔥🔥 (아빠 팔 운동)", playTime: 10,
        desc: "배밀이 전, 엎드려 있는 아기를 수건에 태워 집안 곳곳을 구경시켜줍니다.",
        steps: [
            "1. 거실 맨바닥에 수건을 깔고, 아기를 터미타임 자세로 엎드려 놓습니다. (아기 팔은 수건 밖 바닥을 짚게)",
            "2. 아빠가 수건의 뒷부분(아기 발 쪽)을 잡습니다.",
            "3. 바닥을 닦듯 수건을 천천히 밀며 전진합니다. (아기가 수퍼맨이 된 기분을 느낍니다)",
            "4. 턱이 바닥에 쓸리지 않게 아기가 목을 빳빳하게 들게 유도합니다."
        ],
        dadRole: "아기 턱 안 다치게 속도 조절하며 조심조심 운전하기",
        relatedToyId: null
    },
    { 
        ...
        steps: [
            ...
            "3. 아기가 양손을 교차하며 종이를 찢는 '고급 소근육' 기술을 터득합니다.",
            "4. 찢어진 종이들을 위로 날리며 꽃가루 놀이로 마무리합니다."
        ],
        dadRole: "꽃가루 흩날린 종이 쪼가리들 청소기로 깔끔하게 흡입하기",
        relatedToyId: null
    },
    { 
        id: "p91", title: "장난감 인질 구출 작전", category: "zero", targetAge: ['crawl', 'stand'], 
        targetItem: "종이테이프(마스킹 테이프), 미니카 또는 작은 인형", energyDrain: "🔥🔥 (소근육/초집중)", playTime: 20,
        desc: "테이프로 칭칭 감긴 장난감을 떼어내며 소근육과 집중력을 폭발시키는 시간 순삭 놀이.",
        steps: [
            "1. 거실 매트 바닥이나 유리창에 아기가 평소 좋아하는 작은 장난감을 종이테이프로 붙여 '인질'을 만듭니다.",
            "2. 아기가 꼬물꼬물 손가락 끝으로 테이프를 뜯어내고 장난감을 구출하도록 유도합니다.",
            "3. 뜯어내기 쉽게 테이프 한쪽 끝을 살짝 접어두면 좌절감 없이 더 오래 집중합니다.",
            "4. 장난감을 하나씩 구출할 때마다 폭풍 칭찬을 해주면 성취감이 극대화되어 다음 인질로 돌진합니다."
        ],
        dadRole: "테이프 절단 및 치밀한 인질극 설계, 구출된 장난감 소독 티슈로 닦기",
        relatedToyId: 46
    },
   { 
        id: "p92", title: "무 뽑기 (버티기 훈련)", category: "dad", targetAge: ['crawl', 'stand'], 
        targetItem: "아기용 베개 또는 쿠션", energyDrain: "🔥🔥🔥 (전신 근력/코어)", playTime: 15,
        desc: "기어 다니기 시작한 아기의 전신 코어 근육을 폭발시키는 아빠 전용 놀이입니다.",
        steps: [
            "1. 거실 매트 위에 베개나 푹신한 쿠션을 둡니다.",
            "2. 아기가 베개를 양팔로 꽉 끌어안게(매달리게) 엎드려 눕힙니다.",
            "3. 아빠가 아기의 양쪽 종아리를 잡고 '영차~ 무 뽑자~' 하면서 천천히 뒤로 당깁니다.",
            "4. 아기는 베개를 안 놓치려고 온몸에 힘을 주며 버팁니다. (관절에 무리가 안 가도록 바닥에서 부드럽게만 당겨주세요.)"
        ],
        dadRole: "농부 빙의해서 추임새 넣으며 천천히 뒤로 당기기",
        relatedToyId: null
    },
    { 
        id: "p93", title: "숨겨진 간식 파도찾기", category: "zero", targetAge: ['crawl', 'stand'], 
        targetItem: "종이컵 여러 개, 떡뻥", energyDrain: "🔥🔥 (두뇌 발달/추리)", playTime: 20,
        desc: "강아지 노즈워크? 아닙니다. 아기의 관찰력과 소근육을 동시에 쓰는 야바위 놀이입니다.",
        steps: [
            "1. 거실 바닥에 종이컵 3~5개를 뒤집어 놓습니다.",
            "2. 아기가 보는 앞에서 종이컵 하나 안에 작게 자른 떡뻥(간식)을 숨깁니다.",
            "3. '까까 어디 숨었지~?' 하며 종이컵을 이리저리 섞습니다.",
            "4. 아기가 종이컵을 쳐서 쓰러뜨리고 간식을 찾아내 성취감을 느끼게 합니다."
        ],
        dadRole: "타짜처럼 화려한 손놀림으로 종이컵 섞어주기",
        relatedToyId: null
    },
    { 
        id: "p94", title: "[눕육아] 발바닥 택배 스티커", category: "lieDown", targetAge: ['flip', 'crawl'], 
        targetItem: "잘 떨어지는 스티커", energyDrain: "0 (누워서 발만 내밀기)", playTime: 15,
        desc: "엄마 아빠가 누워서 발바닥만 내어주면 아기들이 알아서 떼어내며 놉니다.",
        steps: [
            "1. 부모는 바닥에 등을 대고 누워, 무릎을 굽히고 발바닥이 아기를 향하게 세웁니다.",
            "2. 발바닥과 발가락에 눈에 잘 띄는 스티커를 여러 장 붙여둡니다.",
            "3. 기어 다니는 아기가 발바닥에 붙은 스티커를 보고 떼어내러 달려옵니다.",
            "4. 스티커를 뗄 때마다 발가락을 꼼지락거리며 반응을 해주면 꺄르르 넘어갑니다."
        ],
        dadRole: "내일 출근해야 하는 아빠의 꿀 같은 눕방 휴식 타임",
        relatedToyId: null
    },
    { 
        id: "p95", title: "지퍼락 얼음 찜질팩 만지기", category: "sick", targetAge: ['tummy', 'flip', 'crawl'], 
        targetItem: "투명 지퍼락 2장, 각얼음", energyDrain: "🔥 (열 내리기/촉감)", playTime: 10,
        desc: "접종열이 나거나 몸이 뜨거울 때, 놀이처럼 즐기면서 자연스럽게 열을 내리는 꿀팁.",
        steps: [
            "1. 튼튼한 투명 지퍼락에 각얼음을 5~6개 넣고 물이 새지 않게 꽉 닫습니다. (지퍼락 2장을 겹쳐서 이중 밀봉 권장)",
            "2. 아기가 앉거나 엎드린 상태에서 지퍼락을 손바닥으로 치고 만지게 둡니다.",
            "3. 차가운 얼음이 녹으면서 움직이는 시각적 재미와 시원한 촉감이 동시에 전달됩니다.",
            "4. 열이 나는 아기의 손바닥과 몸에 살짝살짝 대주며 열을 식혀주는 효과도 있습니다."
        ],
        dadRole: "지퍼락 절대 안 터지게 이중으로 밀봉 테이핑하기",
        relatedToyId: null
    },

    // 🚀 TRACK 1 완성: 엄마 아빠 센스 폭발 5종 (p96 ~ p100)
    { 
        id: "p96", title: "양말 애벌레 구출 작전", category: "zero", targetAge: ['crawl', 'stand'], 
        targetItem: "아빠의 긴 목양말, 작은 장난감 2~3개", energyDrain: "🔥🔥 (양손 협응/소근육)", playTime: 15,
        desc: "긴 양말 속에 인질(장난감)을 넣고 손을 깊숙이 넣어 빼게 만드는 초간단 두뇌 놀이.",
        steps: [
            "1. 목이 긴 아빠 양말 속에 아기가 평소 좋아하는 작은 블록이나 피규어를 쑥 넣습니다.",
            "2. 아기에게 양말을 흔들어주며 안에 무언가 있다는 걸 알려줍니다.",
            "3. 한 손으로는 양말을 잡고, 다른 손으로는 구멍 속을 뒤져 장난감을 꺼내는 '양손 협응'을 연습합니다.",
            "4. 장난감을 꺼내면 과장되게 칭찬해주고, 다시 다른 장난감을 넣어 반복합니다."
        ],
        dadRole: "퇴근 후 깨끗한(냄새 안 나는) 본인 양말 내어주기",
        relatedToyId: null
    },
    { 
        id: "p97", title: "휴지심 메가폰 옹알이", category: "zero", targetAge: ['stand'], 
        targetItem: "다 쓴 키친타월 심 (또는 긴 휴지심)", energyDrain: "🔥 (언어 발달/발성)", playTime: 10,
        desc: "말이 트이려고 할 때, 소리를 모아주는 메가폰 놀이로 폭풍 옹알이를 유도합니다.",
        steps: [
            "1. 다 쓴 길쭉한 키친타월 심을 준비합니다.",
            "2. 한쪽 끝을 엄마 입에 대고 '아~' 소리를 내며 아기 귀 쪽으로 메가폰처럼 들려줍니다.",
            "3. 이번엔 아기 입 쪽에 대주고 소리를 내보라고 유도합니다.",
            "4. 평소와 다르게 소리가 크고 울리는 걸 즐기며 침을 튀겨가며 소리를 지릅니다."
        ],
        dadRole: "휴지심 찌그러지지 않게 잘 보관해두기",
        relatedToyId: null
    },
    { 
        id: "p98", title: "[눕육아] 인간 클라이밍 (엄마 산 등반)", category: "lieDown", targetAge: ['crawl', 'stand'], 
        targetItem: "엄마의 푹신한 몸, 애착 인형", energyDrain: "0 (바닥에 납작 엎드리기)", playTime: 20,
        desc: "온몸으로 기어오르고 싶어 하는 등반 욕구를 누워서 해결해줍니다.",
        steps: [
            "1. 엄마는 거실 매트 중앙에 배를 깔고 완전히 엎드립니다.",
            "2. 엄마의 어깨 위나 엉덩이 너머 반대편에 아기가 좋아하는 인형이나 간식을 둡니다.",
            "3. 아기가 목적지를 향해 엄마의 등짝을 사정없이 밟고 기어오르도록 내버려 둡니다.",
            "4. 아기가 산(엄마)을 정복하는 동안 허리 마사지 효과를 누리세요."
        ],
        dadRole: "아기가 떨어지지 않게 옆에서 베이스캠프(안전요원) 역할 하기",
        relatedToyId: null
    },
    { 
        id: "p99", title: "어둠 속 플래시 그림자 사냥", category: "dad", targetAge: ['crawl', 'stand'], 
        targetItem: "스마트폰 플래시", energyDrain: "🔥🔥🔥 (시각 추적/스피드)", playTime: 15,
        desc: "고양이 낚시의 아기 버전 불 끈 방에서 빛을 잡기 위해 온 방을 기어 다닙니다.",
        steps: [
    ...
    { 
        id: "p100", title: "욕실 벽 치약 그림 그리기", category: "bath-care", targetAge: ['stand'], 
        targetItem: "다 써가는 치약(또는 아기용 치약), 칫솔", energyDrain: "🔥🔥 (서서 집중/소근육)", playTime: 20,
        desc: "목욕 물 받기 전 시간 때우기 좋아요 물 뿌리면 거품이 나면서 청소까지 한 번에 끝납니다.",
        steps: [
            "1. 욕실 타일 벽면에 버리기 직전인 치약을 듬성듬성 짜줍니다.",
            "2. 아기에게 안 쓰는 칫솔이나 청소용 솔을 쥐여줍니다.",
            "3. 벽에 묻은 치약을 벅벅 문지르며 거품이 나는 걸 구경하게 둡니다.",
            "4. 실컷 놀고 나면 샤워기로 물을 뿌려 한 방에 씻겨냅니다. (욕실 청소 개이득)"
        ],
        dadRole: "놀이 끝난 후 샤워기로 타일 구석구석 치약 잔해 씻어내기",
        relatedToyId: null
    }
];
...
// 🌟 최신 유행 트렌드 및 생존템 7선 추가 (쿠팡 링크 적용 완료)
